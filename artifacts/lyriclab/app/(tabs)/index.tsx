...
/**
 * Which mode each character opens. Ruled 2026-08-29: the court is one picture
 * with four tap targets, and each character "gives access to the game mode each
 * character represents". Hoisted out of the tap handler so the acknowledgement
 * can name the same mode the navigation is about to enter.
 */
